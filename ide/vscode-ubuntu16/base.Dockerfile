...
LABEL org.label-schema.docker.dockerfile="/Dockerfile" \
      ...
      org.label-schema.vcs-url="e.g.https://github.com/abner/docker-vscode" \
...
RUN curl -sL https://deb.nodesource.com/setup_6.x -o nodesource_setup.sh && \
    ...
    apt-get install -qq -y --fix-missing \ 
      ...
      ttf-dejavu ttf-ubuntu-font-family ttf-liberation \
      nodejs  libxkbfile1 \
    && \
    #npm install -g npm && \
...
ONBUILD RUN echo 'Creating user: ${MYUSERNAME} wit UID $UID' && \
    ...
    # TODO install monaco font, install libnotify-client, 
    # RUN wget http://ftp.br.debian.org/debian/pool/main/f/fonts-hack/fonts-hack-ttf_2.020-1_all.deb; sudo dpkg -i fonts-hack-ttf_2.020-1_all.deb;
    # zsh
